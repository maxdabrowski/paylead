...
@Component({
  ...
  templateUrl: './change-own-data-modal.component.html',
  styleUrls: ['./change-own-data-modal.component.scss']
})
export class ChangeOwnDataModalComponent  {
  ...
  constructor(private fb:FormBuilder, 
    ...
    public dialogRef: MatDialogRef<ChangeOwnDataModalComponent>,
